...
// export const BookActionPage = (props) => {
...
//         `https://${process.env.REACT_APP_SERVER_URL}/api/v1/loan/book/${params.bookId}`,
//         data
//       );
...
//             </Typography>
//           </Box>
//             {/*------------------ insert BookActionCard here----------------- */}
//         {/* <BookActionCard actionName={"Borrow"} data={props.data}/> */}
